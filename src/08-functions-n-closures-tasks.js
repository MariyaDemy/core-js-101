...
function getPowerFunction(exponent) {
  return function exponentiate(number) {
...
function memoize(func) {
  ...
  return function cacheResult() {
    if (Object.prototype.hasOwnProperty.call(cache, 'res')) {
      return cache.res;
    }
    const result = func();
    cache.res = result;
...
function retry(func, attempts) {
  let timestoCall = attempts;
  return function funcCaller() {
    try {
